...
//   return (
//     <div className='flex gap-5 items-center border p-7 shadow-md rounded-lg'>
//          {/* <NotebookTextIcon width={40} height={90}/> */}
//          <Image src={'/courseicon.png'} alt=' ' width={70} height={70}/>
//         <div className=''>
//             <h2 className='font-bold text-2xl mb-2'>{course?.topic.toUpperCase()}</h2>

//             <p className=''
//             >{course?.courselayout?.courseSummary||course?.courselayout?.course_summary||course?.courselayout?.summary_of_course}</p>
      ...
      <div className='flex items-center gap-8'>
        <div className='relative'>
          <div className='w-20 h-20 rounded-2xl bg-gradient-to-br from-orange-500/20 to-pink-500/20 
            ...
            <Brain className='w-12 h-12 text-orange-400 group-hover:animate-bounce'/>
          </div>
