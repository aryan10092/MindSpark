  ...
  return (
    ...
    className="p-6 flex justify-between items-center">
      ...
      <main className="max-w-6xl mx-auto px-4 py-16">
          ...
          <Link 
            href="/dashboard"
            className="px-8 py-4 bg-gradient-to-r from-orange-400 to-pink-400 text-white rounded-xl font-semibold text-lg 
              hover:from-orange-500 hover:to-pink-500 transition-all shadow-lg shadow-orange-200"
          >
            Get Started
          </Link>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 text-center">
          ...
          <div className="p-6 rounded-xl bg-white shadow-lg">
           ...
           <div className="p-6 rounded-xl bg-white shadow-lg">
            <div className="w-16 h-16 mx-auto  mb-4 rounded-xl bg-orange-100 
