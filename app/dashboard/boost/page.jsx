    ...
    <div className="p-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="border rounded-xl p-6 shadow-md">
                ...
                <button className="mt-6 w-full bg-gray-200 text-gray-800 py-2 rounded-lg hover:bg-gray-300">Current Plan</button>
            </div>
            ...
            <div className="border rounded-xl p-6 shadow-md bg-gray-900 text-white">
                ...
                <div className="text-3xl font-bold mb-4">
                    $1 <span className="text-gray-400 text-lg">/month</span>
                </div>
                <ul className="space-y-3">
                    <li className="flex items-center">
                        <svg className="w-5 h-5 text-green-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
