        ...
        <div className="grid gap-6">
          <div className="border-b pb-4">
            ...
            <p className="flex items-center gap-2">
              <span className={`w-3 h-3 rounded-full ${userDetails?.isMember ?
          ...
          <div className="border-b pb-4">
            ...
            <p className="text-gray-600">Member since: {new Date(user?.createdAt).toLocaleDateString()}
            </p>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-orange-100 rounded-lg p-4">
               ...
               {userDetails?.isMember ? <h2 className='font-medium'>INFINITE</h2>:
